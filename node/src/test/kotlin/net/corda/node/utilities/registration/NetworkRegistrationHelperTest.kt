...
class NetworkRegistrationHelperTest {
    ...
    fun init() {
        ...
        this.rootCaCert = rootCa.certificate
        this.intermediateCaCert = intermediateCa.certificate
        this.nodeCaCert = nodeCa.certificate
    ...
    fun `wrong root cert in truststore`() {
        ...
        val rootCert = X509Utilities.createSelfSignedCACertificate(X500Principal("O=Foo,L=MU,C=GB"), rootKeyPair)
        saveTrustStoreWithRootCa(rootCert)
