...
class NetworkMapTest {
    ...
    fun `node correctly downloads and saves network parameters file on startup`() {
        internalDriver(
            ...
            // from the server and not because, for example, the driver accidently copied them.
    ...
    private fun NodeHandle.onlySees(vararg nodes: NodeInfo) {
        // Make sure the node's aren't getting the node infos from the additional directory
